    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<c:url value="/home"/>">MUMTel Admin</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="<c:url value="/countries?currentPage=1&searchString="/>"><i class="fa fa-fw fa-dashboard"></i> Upload Country Codes</a>
                    </li>
                    <li>
                        <a href="<c:url value="/serviceAndRatesDetails?currentPage=1&searchString="/>"><i class="fa fa-fw fa-edit"></i> Upload Services and Rates</a>
                    </li>
                    <li>
